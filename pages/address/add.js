...
Page({
  ...
  edit: function (id) {
    ...
    wx.request({
      ...
      success: (res) => {
        this.setData({
          cityText: res.data.data.province + ' ' + res.data.data.city + ' ' + res.data.data.region,
  ...
  add: function () {
    var that = this,
      md5 = uts.token();
    console.log(that.data.uname, that.data.uphone, that.data.uaddress)
